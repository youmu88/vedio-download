...
function openPlayer(title, src, id, target = 'browse') {
  ...
  if (isHls && window.Hls && Hls.isSupported()) {
    hls = new Hls({ enableWorker: true, maxBufferLength: 60, fLoader: CachedFragmentLoader });
    hls.loadSource(src);
